...
import pytest
from lys_instr.GUI.SingleMotorGUI import SingleMotorGUI
...
def gui(qtbot):
    ...
    widget = SingleMotorGUI(dummy, 'Test SingleMotorGUI')
...
def test_findWidgets(gui):
    ...
    assert nowAtSpinBox is not None, 'Now at spin-box not found'
