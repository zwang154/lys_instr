...
# To Test the GUI run in the src\python: python -m lys_instr.gui.MultiDetector_SA1
if __name__ == "__main__":
    ...
    detector = MultiDetectorDummy(indexShape=(5, 5), frameShape=(256, 256), exposure=0.1)
    gui = MultiDetectorGUI(detector, wait=False, interval=1, iter=1)
    gui.show()
    sys.exit(app.exec_())