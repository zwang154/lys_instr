...
class MultiMotorDummy(MultiMotorInterface):
    ...
    def __init__(self, *axisNamesAll, **kwargs):
        ...
        self._speed = 0.2
        self._error = np.full(n, False)            # For testing purposes only; do not use for real devices
        self.start()
    ...
    def _isBusy(self):
        ...
        Returns:
            dict: Mapping of axis names to busy state (``bool``).
        """
    ...
    def _isAlive(self):
        ...
        Returns:
            dict: Mapping of axis names to alive state (``bool``).
        """
